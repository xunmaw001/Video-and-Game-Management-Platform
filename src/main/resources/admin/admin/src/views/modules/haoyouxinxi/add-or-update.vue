	...
	<div class="addEdit-block" :style='{"padding":"30px","background":"url(http://codegen.caihongy.cn/20230303/76c3e36e1fa546ef8e134d65e6665618.jpg) center bottom/cover no-repeat fixed","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="对方用户账号" prop="duifangyonghuzhanghao">
					<el-input v-model="ruleForm.duifangyonghuzhanghao" placeholder="对方用户账号" clearable  :readonly="ro.duifangyonghuzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="对方用户账号" prop="duifangyonghuzhanghao">
					<el-input v-model="ruleForm.duifangyonghuzhanghao" placeholder="对方用户账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="对方用户姓名" prop="duifangyonghuxingming">
					<el-input v-model="ruleForm.duifangyonghuxingming" placeholder="对方用户姓名" clearable  :readonly="ro.duifangyonghuxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="对方用户姓名" prop="duifangyonghuxingming">
					<el-input v-model="ruleForm.duifangyonghuxingming" placeholder="对方用户姓名" readonly></el-input>
				</el-form-item>
			</template>
	...
	data() {
		...
		return {
			...
			ro:{
				...
				duifangyonghuzhanghao : false,
				duifangyonghuxingming : false,
			},
			...
			ruleForm: {
				...
				nianling: '',
				tianjiashijian: '',
				duifangyonghuzhanghao: '',
				duifangyonghuxingming: '',
			},
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='duifangyonghuzhanghao'){
							this.ruleForm.duifangyonghuzhanghao = obj[o];
							this.ro.duifangyonghuzhanghao = true;
							continue;
						}
						if(o=='duifangyonghuxingming'){
							this.ruleForm.duifangyonghuxingming = obj[o];
							this.ro.duifangyonghuxingming = true;
							continue;
						}
				}
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.yonghuzhanghao!=''&&json.yonghuzhanghao) || json.yonghuzhanghao==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.duifangyonghuzhanghao = json.yonghuzhanghao
						this.ro.duifangyonghuzhanghao = true;
					}
					if(((json.yonghuxingming!=''&&json.yonghuxingming) || json.yonghuxingming==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.duifangyonghuxingming = json.yonghuxingming
						this.ro.duifangyonghuxingming = true;
					}
				} else {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `haoyouxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.haoyouxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
